...
// Add your favorite technologies here
        ...
        <div className="flex w-full mx-auto text-left">
          <div className="relative inline-flex items-center mx-auto align-middle">
            <div className="pb-12 text-center">
              <h1 className="max-w-5xl text-xl font-bold leading-none tracking-tighter text-black dark:text-neutral-300 md:text-xl lg:text-3xl lg:max-w-7xl">
          ...
          >
            {items.map((item, index) => (
              <div key={index} className="flex items-center space-x-2">
                {item.icon}
                <span className="text-lg font-bold tracking-tighter text-black dark:text-neutral-300">
                  {item.name}
                </span>
              </div>
            ))}
